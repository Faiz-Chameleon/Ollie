                    ...
                    children: [
                      ...
                      widget.groupType == "team" && widget.postData?.finalUserGroupType == 1
                          ...
                          : widget.groupType == "team" && widget.postData?.groupIs == 0
                              ...
                              : widget.groupType == "admin" && widget.postData?.userName == "Admin"
                                  ? GestureDetector(
                                      onTap: () {
                                        print('Navigating to user profile with userId: ${widget.postData!.userId}');
                                        Get.to(() => OtherUserProfileScreen(userId: widget.postData!.userId!));
                            ...
                            children: [
                              widget.postData?.is_repost == 1
                                  ...
                                  : Row(
                                      ...
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        widget.groupType == "admin"
                                            ? Text("Octagon", style: whiteColor16BoldTextStyle)
                          ...
                          GestureDetector(
                            ...
                            onTap: () async {
                              ...
                              await SharePlus.instance.share(
                                ShareParams(
                                  text: 'Check out this post and join the conversation 👇 https://octagonapp.com',
                                  subject: 'Octagon App',
