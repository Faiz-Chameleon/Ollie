...
class NotificationController {
  ...
  //     //     ?.pushNamedAndRemoveUntil('/notification-page', (route) => (route.settings.name != '/notification-page') || route.isFirst, arguments: receivedAction);
  //   }
  // }
  ...
  //                 child: Text(
  //                   'Deny',
  //                   style: Theme.of(context).textTheme.titleLarge?.copyWith(color: colorT.kErrorColor),
  //                 )),
  //             TextButton(
  //                 onPressed: () async {
  //                   userAuthorized = true;
  ...
  ///  *********************************************
  ///
  // static Future<bool> createNewNotification({required String title,required String body, required String imageUrl}) async {
  ...
  //     // SharedPrefProvider().prefs.setBool(StringK.kNotificationPref, true);
