...
class LaravelFlutterPusher {
  ...
  void _handleEvent([dynamic arguments]) async {
    final messageJson = _decodeEventStreamMessage(arguments);
    if (messageJson == null) {
      return;
    }
    var message = PusherEventStreamMessage.fromJson(messageJson);
  ...
  Map<String, dynamic>? _decodeEventStreamMessage(dynamic rawMessage) {
    if (rawMessage == null) {
      return null;
    }
  ...
  dynamic _decodeCallbackPayload(String? rawData) {
